...
CSV_TEXT = """品種名,分類slug,種苗区分,種別,価格,数量表記,採種年,生産地,発芽率,種子消毒,説明,栽培メモ
みやま小かぶ,root-veg,種,固定種,360,約200粒,2025,埼玉県,2026年6月現在 85%以上,無処理,肉質緻密な小かぶ。,秋まき推奨
真黒茄子,fruit-veg,種,固定種,360,約30粒,2025,埼玉県,80%以上,無処理,濃黒紫の中長なす。,
